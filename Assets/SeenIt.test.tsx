...
import SeenIt from '../src/pages/SeenIt';
...
describe('SeenIt', () => {
  it('should display a placeholder message if no films are added', () => {
    ...
    // TODO: After confirming the actions work as expected, change the querySelector
    // back to a class and commit the changes. Then confirm the actions allow the pull requests
